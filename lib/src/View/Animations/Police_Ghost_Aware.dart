...
class Police_Ghost_Aware extends StatefulWidget {
  const Police_Ghost_Aware({super.key});

  @override
  Police_Ghost_AwareState createState() => Police_Ghost_AwareState();
}

class Police_Ghost_AwareState extends State<Police_Ghost_Aware>
  ...
  Map<String, List<String>> ghostMessages = {
    'en': AppLocale.police_ghost_aware_small_texts_en,
    'gr': AppLocale.police_ghost_aware_small_texts_el,
    'sp': AppLocale.police_ghost_aware_small_texts_sp,
    'por': AppLocale.police_ghost_aware_small_texts_por,
    'fr': AppLocale.police_ghost_aware_small_texts_fr,
    'de': AppLocale.police_ghost_aware_small_texts_de,
    'ru': AppLocale.police_ghost_aware_small_texts_ru,
    'ja': AppLocale.police_ghost_aware_small_texts_ja,
    'ch': AppLocale.police_ghost_aware_small_texts_ch,
  };
