...
//import 'package:park/src/View/Components/Big_Texts.dart';
//Routes
                  ...
                  builder: (context, child) {
                    return Transform(
                      ...
                      transform: Matrix4.translationValues(
                          0.0,
                          -30.0 * (1 - (2 * (controller.value - 0.5)).abs()),
                          0.0),
                      child: child,
                    );
                  },
                              ...
                              showDialog(
                                ...
                                builder: (context) {
                                  return Report_Modal(
                                    ...
                                    labelTexts: AppLocale.getString(
                                      context,
                                      AppLocale.you_did_not_accept_small_text,
                                      languageCode: current_locale,
                                    ),
                                    its_error: true,
                                  );
                          ...
                          children: [
                            Small_Texts(
                                ...
                                textSpans: [
                                  ...
                                  TextSpan(
                                    text: AppLocale.getString(
                                        context, AppLocale.privacy_textbutton,
                                        languageCode: current_locale),
                                    style: const TextStyle(
